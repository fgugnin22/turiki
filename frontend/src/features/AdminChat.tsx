...
const AdminChat = (props: ChatProps) => {
  ...
  after:from-lightblue after:to-turquoise after:rounded-[10px] after:z-0 
    ...
    before:bg-gradient-to-b before:from-transparent from-[-100%] before:to-darkturquoise before:to-[900%]"
      >
        <div className="w-full bg-gradient-to-r from-lightblue z-10 to-turquoise p-3 text-center text-lg lg:text-2xl font-semibold relative">
          {whichTeam !== -1
            ? "Чат команды " + props.teams.find((t) => t.id === whichTeam)?.name
            : "Общий чат"}
        </div>
        <div className="z-10 flex flex-col flex-grow mt-auto lg:max-h-[initial] lg:h-0 p-4 overflow-x-scroll scrollbar-none max-w-full relative">
        ...
        <form
          className="flex flex-row pl-8 pr-5 lg:pb-3 pt-auto mb-4 relative z-[101]"
        ...
        <div
          className=" rounded-b-[8px] text-[10px] lg:text-base h-[30px]  z-50 
