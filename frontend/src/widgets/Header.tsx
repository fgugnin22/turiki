      ...
      {isAuthenticated ? (
        <>
          ...
          >
            <div
              className={
                (isDropDownVisible &&
                  "bg-darkestturq !bg-opacity-100 hover:!bg-darkestturq !rounded-b-none") +
            ...
            {isDropDownVisible && (
              <div
                className={
                  ...
                  " relative flex flex-col justify-between items-center rounded-b-[10px] transition-colors hover:bg-darkestturq "
                }
              >
                <NavLink
        ...
        <div className="flex justify-between items-center gap-3">
          <Link
            ...
            type="button"
          >
            <img src={`${serverURL}/assets/img/defaultuser.svg`} alt="" />
            <span
              data-content="Вход"
              className="before:text-lg text-lg before:font-semibold before:bg-gradient-to-r before:from-turquoise before:bg-clip-text before:to-lightblue text-transparent
