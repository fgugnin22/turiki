              ...
              <>
                ...
                >
                  {userDetails?.team &&
                    userDetails?.team_status !== "PENDING" && (
                      <Link
                        ...
                        className="py-2 px-4 block ml-auto bg-green-600 hover:bg-green-700 focus:ring-green-500 focus:ring-offset-green-200 text-white transition ease-in duration-200 text-center text-sm font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 mr-4 rounded-lg "
                        role="menuitem"
                      >
                        <span className="flex flex-col">Моя команда</span>
                      </Link>
                    )}
                  <Link
                    to={ROUTES.DASHBOARD.path}
                  ...
                  <button
                    ...
                    className="py-2 pr-3 pl-2  bg-green-600 hover:bg-green-700 focus:ring-green-500 focus:ring-offset-green-200 text-white w-24 transition ease-in duration-200 text-center text-sm font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-r-lg "
                    role="menuitem"
                  >
                    Выйти
                  </button>
                ...
                {!isAuthenticated && (
                  <>
                    <Link
                      ...
                      type="button"
                      className="py-2 pl-3 pr-2  bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-white w-24 transition ease-in duration-200 text-center text-sm font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-l-lg "
                    >
                      Войти
                    </Link>
                    <Link
