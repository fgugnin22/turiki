    ...
    return (
        <Layout>
            ...
            {isGetMessagesSuccess && isAuthenticated ? (
                <div className="flex flex-col flex-grow w-full max-w-xl bg-white shadow-xl rounded-lg overflow-hidden min-h-[400px]">
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            className="w-[50px] px-2 py-1 my-1 rounded-md bg-slate-200 hover:bg-slate-50 transition-colors active:bg-slate-600"
                        >
                            <svg
